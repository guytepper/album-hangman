...
function Game() {
  ...
  window.addEventListener('keydown', this.keyboardPress); // TODO: Move this to another place, as this will be attached for each new game object.
}
 ...
 */
Game.prototype.getIndiciesOfLetter = function (letter, word) {
  let indices = [];
 ...
 */
Game.prototype.replaceUnderscore = function (arr, letter, indicies) {
